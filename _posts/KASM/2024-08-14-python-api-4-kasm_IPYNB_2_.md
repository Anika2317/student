...
To understand how Kasm reads workspaces from different registries, you can see which workspaces are available in the [Nighthawk Coders Kasm Registry](https://open-coding-society.github.io/kasm_registry/1.0/). This is the access point for Kasm to pull files from Docker Hub, enabling Kasm to add workspaces through different registries, as explained in the [Kasm Workspace Registry Guide](https://kasmweb.com/docs/latest/guide/workspace_registry.html).
...
- Goto Kasm Sever (aka kasm100.nighthawkcodingsociety.com), login admin@kasm.local.   Select from the left panel "Workspace", then "Workspace Registry".  "Add new" registry if "Del Norte HS Computer Science" is not found. Obtain the Registry Link [here](https://open-coding-society.github.io/kasm_registry).
...
- GitHub Pages Location: [kasm_registry GitHub Pages](https://open-coding-society.github.io/kasm_registry/1.0/)  On the server you can view attributes for a workspace in a friendly form.
- GitHub location: [kasm_registry files](https://github.com/open-coding-society/kasm_registry)  The easier way to make a new registry entry, for me, is to copy a folder in Workspaces and adjust entries for your specific branding.

```json
{
    "description": "Nighthawk Coders CSSE Official 2023-2024 Ubuntu Desktop Workspace",
    "docker_registry": "https://index.docker.io/v1/",
    "image_src": "open-coding-society.png",
    "name": "open-coding-society/kasm_workspaces:latest",
    "run_config": {
      "hostname": "kasm"
    },
    "exec_config": {
