...
![Create Security Group](https://github.com/open-coding-society/kasmv2_flask/assets/111611921/cad4d218-51ac-4345-ab90-3355dabc2cb8)
...
<img width="400" alt="image" src="https://github.com/open-coding-society/kasmv2_flask/assets/111611921/a0d49433-f5a8-4cee-bbd5-c8aabfff1551">

### Step 3: Choose a Database Engine
1. Select the database engine you want to use : MySQL
<img width="400" alt="image" src="https://github.com/open-coding-society/kasmv2_flask/assets/111611921/6fdf8877-433e-442d-8b5c-7fb9eda9c7fe">

### Step 4: Configure Database Settings
1. Specify the template as Free teir
<img width="400" alt="image" src="https://github.com/open-coding-society/kasmv2_flask/assets/111611921/e26a110a-9333-49b0-936b-00cf8cd80670">
...
<img width="400" alt="image" src="https://github.com/open-coding-society/kasmv2_flask/assets/111611921/9b0c1d14-2f3a-410c-a696-c1ca20e25e84">

3. Choose the **DB instance size**  : db.t3.micro
<img width="400" alt="image" src="https://github.com/open-coding-society/kasmv2_flask/assets/111611921/599b87ed-a1a9-41d3-b8a3-6af2d7b96487">

### Step 5: Configure Storage
1. Choose the allocated storage size for your database.
2. Enable **storage auto-scaling** if needed.
<img width="400" alt="image" src="https://github.com/open-coding-society/kasmv2_flask/assets/111611921/12ed298f-4f62-4d06-941b-9f2a095c4dce">
...
<img width="400" alt="image" src="https://github.com/open-coding-society/kasmv2_flask/assets/111611921/5a6d4816-5da7-40a3-8c5a-1279b8c8179c">

### Step 7: Authentication Configuration
1. Configure database authentication as password only 
<img width="400" alt="image" src="https://github.com/open-coding-society/kasmv2_flask/assets/111611921/10c40e38-2a62-44a9-b8cd-f70605f68794">
...
<img width="400" alt="image" src="https://github.com/open-coding-society/kasmv2_flask/assets/111611921/e52144d7-b245-4644-a405-fde8fa787a2f">

2. Copy the **Endpoint** and **Port** information.
<img width="400" alt="image" src="https://github.com/open-coding-society/kasmv2_flask/assets/111611921/0cc9400c-23fa-4985-b022-bea4f71bcadf">
...
<img width="400" alt="image" src="https://github.com/open-coding-society/kasmv2_flask/assets/111611921/d7a4143a-1934-474b-8532-5add049e8f8a">
...
The Kasm project is using Python with the Flask framework to manage the database.  The GitHub project `open-coding-society/flask_2005` contains all the model definitions for the RDS instance defined above.
